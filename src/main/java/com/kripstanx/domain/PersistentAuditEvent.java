...
public class PersistentAuditEvent implements Serializable {
    ...
    public String toString() {
        final StringBuffer sb = new StringBuffer("PersistentAuditEvent{");
        sb.append("id=").append(id);
        sb.append(", principal='").append(principal).append('\'');
        sb.append(", auditEventDate=").append(auditEventDate);
        sb.append(", auditEventType='").append(auditEventType).append('\'');
        sb.append('}');
        return sb.toString();
    }
}
